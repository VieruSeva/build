...
const PartnersPage = () => {
  ...
  const [previewModal, setPreviewModal] = useState({ isOpen: false, url: '', title: '', downloadUrl: '' });
  ...
  const mainTechnologySquares = [
    {
      ...
      fullInfo: {
        ...
        downloadFile: {
          ...
          filename: "Oferta Lactate RO.pdf",
          icon: "🥛"
        }
      }
    },
    {
      ...
      fullInfo: {
        ...
        downloadFile: {
          ...
          filename: "Industria Bauturilor.pdf",
          icon: "🍹"
        }
      }
    },
    {
      ...
      fullInfo: {
        ...
        downloadFile: {
          ...
          filename: "Oferta Carne si Oua RO.pdf",
          icon: "🥩"
        }
      }
    }
        ...
        {mainTechnologySquares.map((square, index) => (
          ...
          >
            ...
            <div className="space-y-3">
              <button
                onClick={() => handlePreview(square.fullInfo.downloadFile.filename, square.fullInfo.downloadFile.name)}
              ...
              <button
                onClick={() => handleDownload(square.fullInfo.downloadFile.filename, square.fullInfo.downloadFile.name)}
