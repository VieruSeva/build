...
import { newNewsData } from '../data/newsData';
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        setNewsData({
          ...newNewsData,
          images: [facility1Image, facility2Image, facility3Image, facility4Image] // Use imported images
        });
      } catch (error) {
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-6xl mx-auto">
          <h2 
            ...
            data-aos="fade-up"
          >
            Galeria Foto - Facilitarea tranziției verzi și comerțul transfrontalier
          </h2>
            ...
            {newsData.images.map((image, index) => (
              ...
              >
                <div className="relative overflow-hidden rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                  <img 
                    src={image} 
                    alt={`Facilitarea tranziției verzi ${index + 1}`}
        ...
        <div className="max-w-4xl mx-auto mt-16 text-center">
          <div 
            ...
            data-aos="fade-up"
          >
            <h3 className="text-2xl font-bold mb-4">Alătură-te Tranziției Verzi!</h3>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-90 z-50 flex items-center justify-center p-4">
          <div className="relative max-w-4xl w-full">
            ...
            <div className="flex items-center justify-center">
              <img 
                src={selectedImage} 
                alt={`Facilitarea tranziției verzi ${currentImageIndex + 1}`}
