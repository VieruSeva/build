  ...
  const documents = [
    {
      ...
      filename: "HOTARARE_Cerintelor_Produse_de_panificatie_si_paste_fainoase.pdf",
      type: "pdf",
    ...
    },
    {
      ...
      filename: "Legea cu privirea la comertul interior.pdf",
      type: "pdf",
      icon: <FaFilePdf className="text-red-500 text-2xl" />
    },
    {
    ...
    },
    {
      ...
      filename: "Legea privind siguranta alimentelor.pdf",
      type: "pdf",
      icon: <FaFilePdf className="text-red-500 text-2xl" />
    },
    {
      ...
      filename: "Legea privind intreprinderile mici si mijlocii.pdf",
      type: "pdf",
      icon: <FaFilePdf className="text-red-500 text-2xl" />
    },
    {
