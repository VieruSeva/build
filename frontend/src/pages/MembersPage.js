...
const MembersPage = () => {
  ...
  const members = [
    ...
    },
    {
      ...
      logo: require("../images/MACINATORUL SRL.png"),
      hasLogo: true,
      hasLink: true,
    ...
    },
    {
      ...
      logo: require("../images/BUDNEA RODICA I.I..png"),
      hasLogo: true,
      hasLink: true,
    ...
    {
      name: "BRODEȚCHI SRL",
      logo: require("../images/BRODETCHI SRL.png"),
      hasLogo: true,
      hasLink: true,
  ...
  return (
    ...
    >
      ...
      {/* CTA Section - HIDDEN */}
      <section className="py-16 bg-primary-50" style={{ display: 'none' }}>
        <div className="container mx-auto px-4">
