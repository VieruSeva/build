...
import forumBrutariThumbnail from '../photos/Arhivă/forumul brutarilor/IV-lea_Forum_al_Brutarilor_Patisierilor_si_Morarilor_din_Republica_2.11_(1).jpg'; // Updated to use the specified image
